...
function cbRenderFlat(tbody, total) {
  ...
  tbody.innerHTML = slice.map(r => {
    ...
    return `<tr>
      ...
      <td style="font-family:var(--mono);font-size:11px;color:var(--muted)">${r.sku || '—'}</td>
      <td style="font-family:var(--mono);font-size:12px">${r.satuan || '—'}</td>
      <td><span class="badge badge-blue" style="font-size:11px">${brandNama}</span></td>
